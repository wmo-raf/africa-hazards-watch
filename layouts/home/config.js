...
export default {
  summary: [
    {
      title: "Monitor Africa's hazards through data",
      summary:
        "Explore our data to monitor hazards in Africa",
      buttons: [
        {
    ...
    {
      title: "Be the first to receice new hazards updates",
      summary:
    ...
    {
      title: "Quick continental and country stats",
      summary:
