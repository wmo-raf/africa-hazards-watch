...
export default [
  {
    name: "Cloud Type",
    id: "3_hour_cloud_type",
    dataset: "3_hour_cloud_type",
    type: "dataset",
    published: true,
    status: "saved",
    layer: "3_hour_cloud_type",
    ...
    layers: [
      {
        id: "3_hour_cloud_type",
        dataset: "3_hour_cloud_type",
        name: "3 Hour Cloud Type",
        type: "layer",
        layerConfig: {
          type: "vector",
          source: {
            tiles: [
              "http://localhost:7800/public.hourly_cloud_type/{z}/{x}/{y}.pbf?selected_date={time}",
            ],
            type: "vector",
          },
          render: {
