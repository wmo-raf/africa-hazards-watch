...
const layerName = "rsmc_dar_wrf_lake_victoria_precipitation";
const metadataId = "";
const tileJsonUrl =
  "http://20.56.94.119/hw-cms/api/raster/c43fcead-0caf-4b37-9239-8d319391b90c/tiles.json";
    ...
    layers: [
      {
        ...
        layerConfig: {
          ...
          source: {
            type: "raster",
            tiles: [
              "http://20.56.94.119/hw-cms/api/raster-tiles/c43fcead-0caf-4b37-9239-8d319391b90c/{z}/{x}/{y}?time={time}",
            ],
            minzoom: 3,
            maxzoom: 12,
          },
