    ...
    layers: [
      {
        ...
        layerConfig: {
          ...
          source: {
            type: "raster",
            tiles: [
              `http://197.254.13.228:8081/ows/gfs?service=WMS&request=GetMap&version=1.1.1&width=256&height=256&styles=&transparent=true&srs=EPSG:3857&bbox={bbox-epsg-3857}&format=image/png&time={time}&layers={height}&clip_feature={clip_feature}`,
            ],
            minzoom: 3,
            maxzoom: 12,
          },
