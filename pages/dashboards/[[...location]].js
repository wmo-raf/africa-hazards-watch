...
export const getServerSideProps = async ({ params, query, req }) => {
  ...
  if (!type || type === "africa") {
    ...
    return {
      props: {
        title: "Hazards Watch by Country | AHW",
        ...
        description:
          "Monitor climate and related hazards by country. Analyze climate data and trends, including drought, heavy rainfall and climate change.",
      },
    };
  }
